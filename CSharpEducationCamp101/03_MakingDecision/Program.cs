...
namespace _03_MakingDecision
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            if (username != "Admin") // != Farklıysa demektir
            {
            ...
            // Aritmetik işlemlerde iki sayının birbirine bölümünün kalanını veriyor
            ...
            if (menuItem == "1")
            {
                ...
                Console.WriteLine();
                Console.WriteLine("1-Köri Ssolu Tavuk");
            ...
            #region Switch Case 
            // Switch; kod bloğunun anahtar kısmı. Case; Bu anahtarın durumları
